...
class SelectSubjectWidget(QtWidgets.QWidget):
    def __init__(self, parent=None, *args, **kwargs):
        ...
        self.credits_limit_group_box = CustomFlatGroupBox(self.left_frame)
    ...
    def set_credit_limit(self):
        ...
        if self.choose_program_combobox.current_text == "Chương trình chuẩn":
            self.lower_bound_line_edit.insert("12")
            self.upper_bound_line_edit.insert('24')
            self.lower_bound_line_edit.set_disabled(True)
            self.upper_bound_line_edit.set_disabled(True)
        elif self.choose_program_combobox.current_text == "Chương trình ELITECH":
            self.lower_bound_line_edit.insert('12')
            self.upper_bound_line_edit.insert('24')
            self.lower_bound_line_edit.set_disabled(True)
            self.upper_bound_line_edit.set_disabled(True)
        elif self.choose_program_combobox.current_text == "Khác/Tuỳ chỉnh":
            self.lower_bound_line_edit.set_disabled(False)
            self.upper_bound_line_edit.set_disabled(False)
